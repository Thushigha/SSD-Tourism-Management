...
if(request.getParameterMap().containsKey("Submit")){ //JSP code starting from here 
  ...
  try {
	  ...
	  stmt.executeUpdate("INSERT INTO hotel_tbl (`hotel_name`,`email`,`mobile_no`,`district`) VALUES ('"+hotelname+"', '"+email+"', '"+tpno+"', '"+district+"');");
  ...
  //response.sendRedirect("new_hotel.jsp");
  }
                  ...
                  <div class="card-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group-append">
                              <select class="form-control" name="District" style="width: 100%;"  >
