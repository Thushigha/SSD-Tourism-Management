                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="package-item">
                        ...
                        <div class="text-center p-4">
                            ...
                            <h3 class="mb-0">Package: Package B</h3>
                            <div class="mb-3">
                                <small>Room Facilities: Air Conditioning</small>
                                <small>, Balcony</small>
                            </div>
                            <div class="mb-3">
                                <small> Destination: THailand</small>
                               
                            </div>
                            <div class="mb-3">
                                <small>Activities: Theemed Dinner Nights</small>
                                <small>River Fishing</small>
                            </div>
                            <div class="d-flex justify-content-center mb-2">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="package-item">
                        ...
                        <div class="text-center p-4">
                            ...
                            <h3 class="mb-0">Package: Package A</h3>
                            <div class="mb-3">
                                <small>Room Facilities: Terace</small>
                                <small>, Flat-screen TV</small>
                            </div>
                            <div class="mb-3">
                                <small>Destination: Australia</small>
                            </div>
                            <div class="mb-3">
                                <small>Activities: Bicycle Rental</small>
                                <small>Birds Watching</small>
                            </div>
                            <div class="d-flex justify-content-center mb-2">
                                <a href="booking.html" class="btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;">Book Now</a>
                            </div>
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-transparent" name="FullName"  placeholder="Full Name">
                                        <label for="name">Full Name</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-transparent" name="MobileNumber" placeholder="Mobile Number">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-transparent" name="NIC" placeholder="NIC/Passport Number">
                                        <label for="nic_pass">NIC/Passport Number</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-transparent" name="HotelName" placeholder="Hotel Name">
                                        <label for="select1">Hotel Name</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control bg-transparent" name="PackageName" placeholder="Package Name">
                                        <label for="select1">Package Name</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="number" class="form-control bg-transparent" name="RoomsCount" placeholder="No.of Rooms">
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <select class="form-select bg-transparent" name="Facilities" id="select1">
                                        ...
                                        <label for="select1">Facilities</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date3" data-target-input="nearest">
                                        <input type="text" name="Checkin" class="form-control bg-transparent datetimepicker-input"  placeholder="Check-in Date" data-target="#date3" data-toggle="datetimepicker" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating date" id="date4" data-target-input="nearest">
                                          <input type="text" name="Checkout" class="form-control bg-transparent datetimepicker-input" placeholder="Check-out Date" data-target="#date4" data-toggle="datetimepicker"/>
                                          <label for="date">Check-out Date</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" name="TotalPrice" class="form-control bg-transparent" id="price" placeholder="Total Price">
                                        <label for="price">Total Price</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <select name="PaymentType" class="form-select bg-transparent" id="select1">
                                            <option selected="selected">Choose...</option>
                                ...
                                <div class="col-12">
                                   ...
                                   <button name = "Submit" type="submit" onclick="showAlert()" class="btn btn-outline-light w-100 py-3 px-5 mt-2">Book Now</button>
                                </div>
                            </div>
                        </form>
                </div>
