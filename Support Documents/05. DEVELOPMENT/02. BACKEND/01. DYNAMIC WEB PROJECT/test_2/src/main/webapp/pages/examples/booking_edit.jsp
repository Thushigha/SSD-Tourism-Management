...
if(request.getParameter("Submit")!=null)
{
    ...
    pst = con.prepareStatement("update booking_tbl set fullname=?,nic=?,hotelname=?,packagename=?,roomcount=?,facilities=?,email=?,tpno=?,checkin=?,checkout=?,totalprice=?,paymenttype=? ,status=? where id = ?");
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../forms/new_booking.html" class="nav-link">Update Booking</a>
      </li>
    </ul>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <%   
                        ...
                        pst = con.prepareStatement("select * from booking_tbl where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
