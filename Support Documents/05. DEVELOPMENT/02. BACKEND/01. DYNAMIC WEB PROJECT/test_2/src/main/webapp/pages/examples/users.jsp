...
<head>
  ...
  <title>Tourism_Management_Users</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../examples/users.html" class="nav-link">Users</a>
      </li>
    </ul>
          ...
          <table class="table table-striped packages">
              ...
              <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/tourism_management","root","");
                                  ...
                                  String query = "select * from tourist_tbl";
                             ...
                             <tr>
                                 <td><%=rs.getString("tourist_uname") %></td>
                                 <td><%=rs.getString("tourist_nic_passport") %></td>
                                 <td><%=rs.getString("tourist_email") %></td>
                                 <td><%=rs.getString("tourist_password") %></td>
                                 <td><%=rs.getString("tourist_tp_no") %></td>
                                 <td><%=rs.getString("tourist_country") %></td>
                                 <td class="project-actions text-right">			                          
			                          <a class="btn btn-info btn-sm" href="users_edit.jsp?id=<%=id%>">
			                              
			                              Edit
			                          </a>
			                          <a class="btn btn-danger btn-sm" onclick="showAlertD()" href="users_delete.jsp?id=<%=id%>">
			                              Delete
			                          </a>
			                      </td>
