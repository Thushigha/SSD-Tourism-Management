        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="service.jsp" class="nav-item nav-link active">Hotels</a>
            ...
            <div class="row g-4 justify-content-center">
                 ...
                 <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/tourism_management","root","");
                                  ...
                                  String query = "select * from hotel_tbl";
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="text-center p-4">
                            <h3 class="mb-0"><%=rs.getString("hotel_name") %></h3>
                            <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-center mb-2">
                                <a href="package.jsp" class="btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;">View Packages</a>
                            </div>
                        </div>
                    </div>
                </div>
