...
if(request.getParameterMap().containsKey("Submit")){ //JSP code starting from here 
    ...
    ItemNames = request.getParameterValues("Facilities");
...
<%      
  ...
  try {
	  ...
	  stmt.executeUpdate("INSERT INTO booking_tbl (`fullname`,`nic`,`hotelname`,`packagename`,`roomcount`,`facilities`,`email`,`tpno`,`checkin`,`checkout`,`totalprice`,`paymenttype`,`status`) VALUES ('"+fullname+"', '"+nic+"', '"+hotelname+"', '"+packagename+"', '"+roomcount+"', '"+facilities+"', '"+email+"', '"+tpno+"', '"+checkin+"', '"+checkout+"', '"+totalprice+"', '"+paymenttype+"', '"+status+"');");
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-3">
                            <div class="form-group">
                              ...
                              <div class="input-group-append">
                                  <select name="HotelName" class="form-control"  style="width: 100%;"  >
                                    <option value="0">Please select</option>
                                    <option value="Valampuri">Granbell Hotel Colombo</option>
									<option value="Jetwing">Jetwing Colombo</option>
									<option value="Village Hotel">Village Hotel</option>
									<option value="OneGalleFace">Cinnamon Lakeside</option>
									<option value="Taj Samudra">Taj Samudra</option>
									<option value="Fairway Colombo">Fairway Colombo</option>
                                  </select>
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group-append">
                              <select name="PackageName" class="form-control"  style="width: 100%;"  >
                            ...
                            <div class="col-3">
                              <div class="form-group">
                                ...
                                <div class="input-group-append">
                                  ...
                                  <input type="number" name="RoomsCount" class="form-control"  placeholder="No.of.Rooms">
                                </div>
                                </div>
                                </div>
                            </div>
                         ...
                         <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group-append">
                              <select class="select2" name="Facilities"  multiple="multiple" data-placeholder="Select Activities" style="width: 400%;">
                                 <option name="Facilities" value="0">Please Select</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" data-target-input="nearest">
                              <input type="date" name="Checkin" data-target="#reservationdate"/>
                              <div class="input-group-append" >
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group date" id="reservationdate2" data-target-input="nearest">
                            <input type="date" name="Checkout" data-target="#reservationdate"/>
                            <div class="input-group-append" >
                                <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                            </div>
                        </div>
                      ...
                      <div class="col-3">
                        <div class="form-group">
                          ...
                          <div class="input-group-append">
                              <select name="PaymentType" class="form-control" placeholder="Please Select" style="width: 100%;"  >
