...
if(request.getParameterMap().containsKey("Submit")){ //JSP code starting from here 
  ...
  try {
	  ...
	  stmt.executeUpdate("INSERT INTO package_tbl (`hotel_name`,`package_name`,`cancel_policy`,`room_facility`,`destination`,`fun_things`,`price`) VALUES ('"+hotel_name+"', '"+package_name+"', '"+cancel_policy+"', '"+room_facility+"', '"+destination+"', '"+fun_things+"', '"+price+"');");
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group-append">
                              <select class="select2" name="HotelName"  data-placeholder="Hotel Name" style="width: 400%;">
                                <option>Granbay Hotel Colombo</option>
