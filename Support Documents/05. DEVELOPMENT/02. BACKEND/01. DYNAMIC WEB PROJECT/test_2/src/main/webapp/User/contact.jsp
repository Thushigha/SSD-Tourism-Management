...
if(request.getParameterMap().containsKey("Submit")){ //JSP code starting from here 
  ...
  try {
	  ...
	  stmt.executeUpdate("INSERT INTO feedback_tbl (`name`,`email`,`hotel`,`package`,`message`) VALUES ('"+name+"', '"+email+"', '"+hotel+"', '"+pack+"', '"+message+"');");
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">12th Street, Nallur, Jaffna</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-4">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">tourism@gmail.com</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <label for="subject">Hotel</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="Package" placeholder="Package">
                                    <label for="subject">Package</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="Message" placeholder="Leave a message here" style="height: 100px"></textarea>
