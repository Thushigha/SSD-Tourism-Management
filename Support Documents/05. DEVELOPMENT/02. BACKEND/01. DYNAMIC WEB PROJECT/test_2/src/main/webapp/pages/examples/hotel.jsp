...
<head>
  ...
  <title>Tourism_Management_Hotels</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../examples/pakages.html" class="nav-link">Hotel Management</a>
      </li>
    </ul>
              ...
              <%   
                             ...
                             <tr>
                                 ...
                                 <td class="project-actions text-right">			                          
			                          <a class="btn btn-info btn-sm" href="hotel_edit.jsp?id=<%=id%>">
			                              
			                              Edit
			                          </a>
			                          <a class="btn btn-danger btn-sm" onclick="showAlertD()" href="hotel_delete.jsp?id=<%=id%>">
			                              Delete
			                          </a>
			                      </td>
