...
if(request.getParameterMap().containsKey("Submit")){ //JSP code starting from here 
  ...
  try {
	  ...
	  stmt.executeUpdate("INSERT INTO tourist_tbl (`tourist_uname`,`tourist_nic_passport`,`tourist_email`,`tourist_password`,`tourist_tp_no`,`tourist_country`) VALUES ('"+fullname+"', '"+nic+"', '"+email+"', '"+password+"', '"+mb_no+"', '"+country+"');");
