...
if(request.getParameter("Submit")!=null)
{
    ...
    pst = con.prepareStatement("UPDATE package_tbl set hotel_name = ?,package_name =?,cancel_policy= ?,room_facility = ?,destination =?,fun_things= ?,price= ? where id = ?");
    pst.setString(1, hotel_name);
    pst.setString(2, package_name);
    pst.setString(3, cancel_policy);
    pst.setString(4, room_facility);
    pst.setString(5, destination);
    pst.setString(6, fun_things);
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <%    
                        ...
                        pst = con.prepareStatement("select * from package_tbl where id = ?");
                        pst.setString(1, id);
                        rs = pst.executeQuery();
                  ...
                  <div class="card-body">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-3">
                          <div class="form-group">
                            ...
                            <div class="input-group-append">
                              <select class="select2" name="HotelName" value="<%= rs.getString("hotel_name")%>" data-placeholder="Hotel Name" style="width: 400%;">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" name="PackageName" value="<%= rs.getString("package_name")%>" class="form-control"  placeholder="Package name">
                        </div>
                      </div>
</div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <div class="input-group-append">
                              <select class="select2" name="RoomFacility" value="<%= rs.getString("room_facility")%>" multiple="multiple" data-placeholder="Select Activities" style="width: 400%;">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group-append">
                              <select class="select2" name="Destination" value="<%= rs.getString("destination")%>" multiple="multiple" data-placeholder="Select Destinations" style="width: 400%;">
                        ...
                        <div class="row">
                          ...
                          <div class="col-3">
                            <div class="form-group">
                              ...
                              <div class="input-group-append">
                                  <select class="form-control" name="CancelPolicy" value="<%= rs.getString("cancel_policy")%>" style="width: 100%;"  >
                          ...
                          <div class="col-6">
                            <div class="form-group">
                              ...
                              <div class="input-group-append">
                                <select class="select2" name="FunThings" value="<%= rs.getString("fun_things")%>" multiple="multiple" data-placeholder="Select Activities" style="width: 400%;">
                                  <option>Bicycle Rental</option>
                                  <option>Live Music/Performance</option>
                      ...
                      <div class="input-group mb-3">
                        ...
                        <input type="text" name="Price" value="<%= rs.getString("price")%>" class="form-control" placeholder="Total Price">
                      </div>
                      </div>
                        </div>
