...
<head>
  ...
  <title>Tourism_Management_Feedback_Review</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Feedback Review</a>
      </li>
    </ul>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="feedback.jsp" class="nav-link active">
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <%   
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/tourism_management","root","");
                                  ...
                                  String query = "select * from feedback_tbl";
