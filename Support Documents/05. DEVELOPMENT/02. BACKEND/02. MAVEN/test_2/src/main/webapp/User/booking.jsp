...
if(request.getParameterMap().containsKey("Submit")){ //JSP code starting from here 
  ...
  try {
	  ...
	  stmt.executeUpdate("INSERT INTO booking_tbl (`fullname`,`nic`,`hotelname`,`packagename`,`roomcount`,`facilities`,`email`,`tpno`,`checkin`,`checkout`,`totalprice`,`paymenttype`) VALUES ('"+fullname+"', '"+nic+"', '"+hotelname+"', '"+packagename+"', '"+roomcount+"', '"+facilities+"', '"+email+"', '"+tpno+"', '"+checkin+"', '"+checkout+"', '"+totalprice+"', '"+paymenttype+"');");
  ...
  //response.sendRedirect("new_booking.jsp");
